...
other_usernames = user_details$username %>% Filter(function(x) !(x %in% all_graphs_distance$username.x), .)
final_graph = igraph::graph_from_data_frame(all_graphs_distance) 
